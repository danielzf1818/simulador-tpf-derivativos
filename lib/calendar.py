...
def du_entre(d1: date, d2: date) -> int:
    """Dias uteis entre d1 e d2 (exclui d1, inclui d2 se DU).

    Convencao ANBIMA: liquidacao inclusive, vencimento exclusive.
    Equivale a NETWORKDAYS(d1, d2, feriados) - 1.
    """
    count = 0
